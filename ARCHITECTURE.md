...
| `md` | 768px | Планшеты; `NoteMetadata` drawer → боковая панель |
| `lg` | 1024px | Ноутбуки; `AppSidebar` drawer → фиксированная панель |
| `3xl` | 1400px | Широкие экраны; полная ширина боковых панелей (`w-80`) |

На экранах < 1400px боковые панели уже: `w-64 lg:w-72`.

### Стратегия лейаута

- **Мобильные**: Одна колонка, сворачиваемая боковая панель (гамбургер-меню)
- **Планшеты**: Боковая панель как оверлей или узкая постоянная панель
- **Десктопы**: Полная боковая панель + разделённый вид редактора

### Ключевые адаптивные компоненты

- Боковая панель: drawer на мобильных, фиксированная на десктопе
