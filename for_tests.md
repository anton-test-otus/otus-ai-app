...
### Smoke
- [ ] Создать заметку с title: `<img src=x onerror=alert(1)>`
- [ ] Открыть поиск, ввести запрос без совпадения с title
- [ ] Открыть полный поиск (Enter)
...
### Smoke
- [ ] В контент заметки вставить:
  ```markdown
  <script>alert(1)</script>
  <img src=x onerror=alert(1)>
  ```
- [ ] Открыть preview и режим редактора
- [ ] Открыть печать (`NotePrintView`)
